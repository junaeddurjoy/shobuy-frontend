...
const LogIn = () => {
    return (
        <div className="grid grid-cols-1 lg:grid-cols-2 bg-[url('https://i.ibb.co/pPdpM5V/background-2.jpg')] p-10 min-h-screen bg-opacity-30">
            ...
            <div className="bg-gradient-to-t from-[#222222] to-[#050505] shadow-2xl rounded-2xl w-[w-[316px]] lg:w-[616px] h-[420px] ">
                ...
                <label className="form-control w-full max-w-xs mx-auto pt-10">
                    ...
                    <button className="btn btn-outline btn-warning w-28 rounded-3xl hover:font-bold mx-auto mt-4">Send OTP</button>
                </label>
            </div>
        </div>
    );

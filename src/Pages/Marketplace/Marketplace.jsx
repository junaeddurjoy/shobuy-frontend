        ...
        <div className="py-10 lg:py-20 px-10 lg:px-20">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4">
                <div className="col-span-2 row-span-2 rounded-xl shadow-2xl p-5 m-5">
                    <div>
                        <img className="rounded-xl" src="public/assets/images/marketplace/marketplace-1.jpg" alt="" />
                    </div>
                    <div>
                ...
                <div className="col-span-2 flex items-center bg-[#E6E5FF] rounded-xl shadow-2xl p-5 m-5">
                    ...
                    <div>
                        <img src="public/assets/images/marketplace/marketplace-2.png" alt="" />
                    </div>
                </div>
                <div className=" bg-[#FEEB9D] rounded-xl shadow-2xl m-5 ">
                    ...
                    <div>
                        <img className="rounded-xl" src="public/assets/images/marketplace/marketplace-3.png" alt="" />
                    </div>
                </div>
                <div className=" bg-pink-200 rounded-xl shadow-2xl m-5 ">
                    ...
                    <div>
                        <img className="rounded-xl" src="public/assets/images/marketplace/marketplace-4.png" alt="" />
                    </div>
                </div>
                <div className="h-[30rem]  bg-[#E6E5FF] rounded-xl shadow-2xl m-5 ">
                    <div>
                        <img className="rounded-xl" src="public/assets/images/marketplace/marketplace-5.png" alt="" />
                    </div>
                    <div className="p-5">
                ...
                <div className="col-span-3 flex bg-[#DEFFE9] rounded-xl shadow-2xl m-5 ">
                    ...
                    <div className="">
                        <img className="ml-[43px] mt-[40px] w-[38rem] h-[28rem] rounded-xl" src="public/assets/images/marketplace/marketplace-6.png" alt="" />
                    </div>
                </div>
            </div>
        </div>

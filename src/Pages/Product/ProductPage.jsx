                    ...
                    <div className="hero-content flex-col lg:flex-row ">
                        <div className="carousel w-full rounded-xl">
                            <div id="slide1" className="carousel-item relative w-full rounded-lg">
                                <img src="/public/assets/images/product/product-1.jpg" className="w-full rounded-xl" />
                            ...
                            <div id="slide2" className="carousel-item relative w-full">
                                <img src="/public/assets/images/product/product-6.jpg" className="w-full" />
                                <div className="absolute flex justify-between transform -translate-y-1/2 left-5 right-5 top-1/2">
                            ...
                            <div id="slide3" className="carousel-item relative w-full">
                                <img src="/public/assets/images/product/product-2.jpg" className="w-full" />
                                <div className="absolute flex justify-between transform -translate-y-1/2 left-5 right-5 top-1/2">
                                    <a href="#slide2" className="btn btn-circle">❮</a>
                                    <a href="#slide4" className="btn btn-circle">❯</a>
                                </div>
                            ...
                            <div id="slide4" className="carousel-item relative w-full">
                                <img src="/public/assets/images/product/product-4.jpg" className="w-full" />
                                <div className="absolute flex justify-between transform -translate-y-1/2 left-5 right-5 top-1/2">
                                    <a href="#slide3" className="btn btn-circle">❮</a>
                            ...
                            <div id="slide5" className="carousel-item relative w-full">
                                <img src="/public/assets/images/product/product-3.jpg" className="w-full" />
                                <div className="absolute flex justify-between transform -translate-y-1/2 left-5 right-5 top-1/2">
                                    <a href="#slide4" className="btn btn-circle">❮</a>
                            ...
                            <div id="slide6" className="carousel-item relative w-full">
                                <img src="/public/assets/images/product/product-5.jpg" className="w-full" />
                                <div className="absolute flex justify-between transform -translate-y-1/2 left-5 right-5 top-1/2">
                                    <a href="#slide5" className="btn btn-circle">❮</a>
                                    <a href="#slide1" className="btn btn-circle">❯</a>
                                </div>
